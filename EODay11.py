...
#Look up the sum() function to help you do this.
        def calculate_score(cards):
            ...
            if score == 21 and cards_in_hand == 2:
                return 0

            elif score > 21 and ace_found:
                cards.remove(11)
                cards.append(1)
                score = sum(cards)
        ...
        while play_again:
            ...
            result = check_result(player_score)
            if result == "win" or result == "lose":
                ...
                result = check_result(dealer_score)
                if result == "win" or result == "lose":
                    play_again = False
                    game_over = True
            ...
            print(player_card)
            print(dealer_card)
            print(f"You have {player_score}.  Dealer has {dealer_score}")

            if player_won:
                print("You are the champion!!")
            elif dealer_won:
                print(caesarart.slap)
